...
DATA		    :=	data
INCLUDES	    :=	inc
APP_TITLE       :=  Input Viewer
APP_DESCRIPTION :=  Background Input Viewer
APP_AUTHOR      :=  N3rds/Phlex
APP_PRODUCT_CODE:=  CTR-N-AIVA
APP_UNIQUE_ID   :=  0x04956
...
CFLAGS	+=	$(INCLUDE) -DARM11 -D_3DS -DNO_UI

CXXFLAGS	:= $(CFLAGS) -fno-rtti -std=gnu++11 -fpermissive 
